namespace ETorrent {
	public class Session : Object {
		...
		Value session_get (string parameter) throws GLib.Error {
			...
			var node = parser.get_root().get_object().get_object_member ("arguments").get_member (parameter);
		...
		double session_get_double (string parameter) throws GLib.Error {
			var val = session_get (parameter);
		...
		public void add (Torrent torrent) throws GLib.Error {
			...
			if (torrent.created_from_path)
				object.set_string_member ("metainfo", torrent.metainfo);
			else
		...
		public double seed_ratio_limit {
			get { return session_get_double ("seedRatioLimit"); }
